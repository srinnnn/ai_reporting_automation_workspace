...
Current visual regression foundation is stored in `tests/visual/`. `tests/visual/runtime/homepage.png` is generated by Playwright from the real runtime at `http://127.0.0.1:8785/`.
