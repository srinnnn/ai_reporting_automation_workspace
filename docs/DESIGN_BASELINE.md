...
- Runtime screenshot evidence:
  ...
  - `tests/visual/runtime/workspace-ecco.png`
  - `tests/visual/runtime/workspace-bsh.png`

Current structural visual regression foundation is stored in `tests/visual/`. Runtime screenshots are generated by Playwright from the real runtime at `http://127.0.0.1:8785/` as visual evidence; pixel screenshot comparison remains pending.
